            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item ">
                                    <a href="{{url('/admin/ecommerce/products')}}" class="nav-link e-fonts">
                                        <i class="far fa-circle nav-icon e-icon"></i>
                                        <span>Products</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('dashboard.users.index')}}" class="nav-link e-fonts">
                                        <i class="far fa-circle nav-icon e-icon"></i>
                                        <span class="">Users</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{url('/dashboard//ecommerce/addproduct')}}" class="nav-link e-fonts">
                                        <i class="far fa-circle nav-icon e-icon"></i>
